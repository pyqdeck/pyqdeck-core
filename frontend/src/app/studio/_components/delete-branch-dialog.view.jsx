...
export function DeleteBranchDialogView({
  branch,
  open,
  onOpenChange,
  onDelete,
      ...
      <AlertDialogContent className="border shadow-none">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="font-roboto">
            ...
            <span className="text-foreground font-bold">{branch?.name}</span>{' '}
            and all its associated semesters, subjects and question papers. This
