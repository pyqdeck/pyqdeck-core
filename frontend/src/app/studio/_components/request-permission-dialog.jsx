...
import { RequestPermissionDialogView } from './request-permission-dialog.view';

export function RequestPermissionDialog({ open, onOpenChange, onRequest }) {
  const api = useApi();
